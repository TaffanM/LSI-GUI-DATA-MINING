...
"}")
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 100, 421, 61))
        font = QtGui.QFont()
        font.setFamily("Poppins")
        ...
        self.listView.setGeometry(QtCore.QRect(30, 170, 611, 251))
        font = QtGui.QFont()
        font.setFamily("Poppins")
...
"}")
        ...
        #Button preprocess 
        self.pushButton_7.clicked.connect(self.preprocess_file)
    ...
    def browse_file(self):
        ...
        if file_name:
            ...
            self.model.appendRow(QtGui.QStandardItem(file_base_name))
